...
function ImageGallery({ images = [], video, alt }) {
  const slides = video ? [{ type: 'video', src: video }, ...images.map(s => ({ type: 'image', src: s }))] : images.map(s => ({ type: 'image', src: s }));
    ...
    <>
      ...
      <nav>
        ...
        <div className="nav-controls">
          <Link to="/#contact" className="btn btn-gold" style={{ fontSize: '0.8rem', padding: '0.5rem 1.2rem' }}>Let's Talk</Link>
        </div>
      </nav>
      ...
      <main className="pg-main">
        ...
        <div className="pg-hero fade-in">
          ...
          <Link to="/#projects" className="btn btn-gold" style={{ alignSelf: 'flex-start', whiteSpace: 'nowrap' }}>
            ← All Projects
          </Link>
        </div>
        ...
        <div className="fade-in">
          <ImageGallery video={project.video} images={project.images} alt={project.title} />
        </div>
